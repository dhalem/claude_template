...
# ---------------------------------------------------------------------
# ADAPTIVE CLAUDE CODE SAFETY GUARD - PYTHON WRAPPER
# ---------------------------------------------------------------------
#
# This script is a wrapper that calls the Python implementation of the
# adaptive safety guard system. The Python version provides enhanced
# functionality, better error handling, and comprehensive testing.
#
# MIGRATION NOTE:
