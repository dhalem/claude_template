...
class TestEmbeddingGenerator:
    ...
    def test_generate_embedding_python_function_real(self):
        ...
        generator = EmbeddingGenerator(
            model_name="simple", model_path="all-MiniLM-L6-v2", chunking_strategy="function_based", preprocess=True
        )
...
def fibonacci(n):
    ...
    def test_generate_embedding_javascript_code_real(self):
        ...
        generator = EmbeddingGenerator(
            model_name="simple", model_path="all-MiniLM-L6-v2", chunking_strategy="semantic", preprocess=True
        )
...
const calculateArea = (radius) => {
    ...
    def test_generate_embedding_from_real_file(self):
        ...
        generator = EmbeddingGenerator(
            model_name="simple", model_path="all-MiniLM-L6-v2", chunking_strategy="function_based"
        )
...
class ExampleClass:
    ...
    def test_similarity_comparison_real(self):
        ...
        generator = EmbeddingGenerator(model_name="simple", model_path="all-MiniLM-L6-v2")
    ...
    def test_large_file_processing_real(self):
        ...
        for i in range(1, 21):  # 20 functions
            large_code_lines.extend(
                [f"def function_{i}(x):", f"    '''Function number {i}'''", f"    return x * {i}", ""]
            )
    ...
    def test_configuration_validation_real(self):
        ...
        with pytest.raises(InvalidChunkSizeError):
            EmbeddingGenerator(
                model_name="simple", model_path="all-MiniLM-L6-v2", chunking_strategy="fixed_size", chunk_size=-1
            )
