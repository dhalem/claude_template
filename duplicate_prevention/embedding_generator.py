...
class CodePreprocessor:
    ...
    def normalize_code(self, code: str, language: str) -> str:
        ...
        if language not in self.supported_languages:
            raise UnsupportedLanguageError(f"Language '{language}' not supported. Supported: {list(self.supported_languages)}")
...
class ChunkingStrategy:
    ...
    def __init__(self, strategy: str = "fixed_size", chunk_size: int = 512,
                 overlap: int = 50, max_chunk_size: Optional[int] = None):
...
class EmbeddingGenerator:
    ...
    def __init__(self, model_name: str = "simple", model_path: str = "all-MiniLM-L6-v2",
                 chunking_strategy: str = "function_based", chunk_size: int = 512,
                 overlap: int = 50, preprocess: bool = True,
                 extract_metadata: bool = True, batch_size: int = 32,
